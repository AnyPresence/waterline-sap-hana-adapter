...
# waterline-waterline-sap-hana-adapter

Provides easy access to `waterline-sap-hana-adapter` from Sails.js & Waterline.
...
```sh
$ npm install waterline-waterline-sap-hana-adapter
```
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/waterline-waterline-sap-hana-adapter/README.md)
